...
class Normalizer:
    ...
    def __init__(
        ...
        if lang == "en":
            ...
            from nemo_text_processing.text_normalization.bn.taggers.tokenize_and_classify import ClassifyFst
            from nemo_text_processing.text_normalization.bn.verbalizers.verbalize_final import VerbalizeFinalFst
            ...
            from nemo_text_processing.text_normalization.bho.taggers.tokenize_and_classify import ClassifyFst
            from nemo_text_processing.text_normalization.bho.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'mag':  # Magadhi
            from nemo_text_processing.text_normalization.mag.taggers.tokenize_and_classify import ClassifyFst
            from nemo_text_processing.text_normalization.mag.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'cg':  # Chhattisgarhi
            from nemo_text_processing.text_normalization.cg.taggers.tokenize_and_classify import ClassifyFst
            from nemo_text_processing.text_normalization.cg.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'mai':  # Maithili
            from nemo_text_processing.text_normalization.mai.taggers.tokenize_and_classify import ClassifyFst
            from nemo_text_processing.text_normalization.mai.verbalizers.verbalize_final import VerbalizeFinalFst
        elif lang == 'te':  # Telugu
            ...
            from nemo_text_processing.text_normalization.mr.taggers.tokenize_and_classify import ClassifyFst
            from nemo_text_processing.text_normalization.mr.verbalizers.verbalize_final import VerbalizeFinalFst
