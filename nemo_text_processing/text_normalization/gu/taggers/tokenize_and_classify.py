...
from nemo_text_processing.text_normalization.gu.taggers.time import TimeFst
from nemo_text_processing.text_normalization.gu.taggers.whitelist import WhiteListFst
from nemo_text_processing.text_normalization.gu.taggers.word import WordFst
    ...
    def __init__(
        ...
        if cache_dir is not None and cache_dir != "None":
            ...
            far_file = os.path.join(
                cache_dir,
                f"gu_tn_{deterministic}_deterministic_{input_case}_{whitelist_file}_tokenize.far",
            )
