...
NEMO_GU_DIGIT = pynini.union("૦", "૧", "૨", "૩", "૪", "૫", "૬", "૭", "૮", "૯").optimize()
NEMO_GU_NON_ZERO = pynini.union("૧", "૨", "૩", "૪", "૫", "૬", "૭", "૮", "૯").optimize()
NEMO_GU_ZERO = "૦"
...
GU_DEDH = "અડધું"  # 1.5
GU_DHAI = "બે અડધા"  # 2.5
GU_SAVVA = "પાવ"  # quarter more (1.25)
GU_SADHE = "સાડા"  # half more (X.5)
GU_PAUNE = "પોણા"  # quarter less (0.75)
