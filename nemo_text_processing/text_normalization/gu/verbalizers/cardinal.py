...
from nemo_text_processing.text_normalization.gu.graph_utils import NEMO_NOT_QUOTE, GraphFst, delete_space
...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        self.optional_sign = pynini.cross("negative: \"true\"", "ઋણાત્મક ")
