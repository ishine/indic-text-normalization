...
from nemo_text_processing.text_normalization.gu.graph_utils import NEMO_NOT_QUOTE, NEMO_SPACE, GraphFst, delete_space


class DateFst(GraphFst):
    """
    Finite state transducer for verbalizing date, e.g.
        date { day: "એક" month: "એપ્રિલ" year: "બે હજાર ચોવીસ" } -> "એક એપ્રિલ બે હજાર ચોવીસ"
        date { month: "એપ્રિલ" day: "એક" year: "બે હજાર ચોવીસ" } -> "એપ્રિલ એક બે હજાર ચોવીસ"
