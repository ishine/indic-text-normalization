...
class TelephoneFst(GraphFst):
    ...
    Finite state transducer for verbalizing telephone numbers, e.g.
        telephone { country_code: "પ્લસ નવ એક", number_part: "નવ બે એક શૂન્ય પાંચ એક પાંચ છ શૂન્ય છ" } ->  પ્લસ નવ એક નવ બે એક શૂન્ય પાંચ એક પાંચ છ શૂન્ય છ
        telephone { number_part: "શૂન્ય એક ત્રણ સાત ચાર ત્રણ શૂન્ય નવ નવ આઠ આઠ" } -> શૂન્ય એક ત્રણ સાત ચાર ત્રણ શૂન્ય નવ નવ આઠ આઠ
