...
# Load the number mappings from the TSV file (contains both Arabic and Tamil digit mappings)
digit_to_word = pynini.string_file(get_abs_path("data/telephone/number.tsv"))

# Pattern to match any digit (Arabic or Tamil)
...
class TelephoneFst(GraphFst):
    """
    Finite state transducer for classifying telephone numbers in Tamil.

    Supports:
        - Phone numbers with separators (dash, dot)
        - International format with country code (+91, etc.)
        - Both Arabic (0-9) and Tamil (௦-௯) digits
        - Minimum 7 digits to be recognized as telephone

    Examples:
        1374-309988 -> telephone { number_part: "ஒன்று மூன்று ஏழு நான்கு மூன்று பூஜ்யம் ஒன்பது ஒன்பது எட்டு எட்டு" }
        ௧௩௭௪-௩௦௯௯௮௮ -> telephone { number_part: "ஒன்று மூன்று ஏழு நான்கு மூன்று பூஜ்யம் ஒன்பது ஒன்பது எட்டு எட்டு" }
        +91 9876543210 -> telephone { country_code: "பிளஸ் ஒன்பது ஒன்று" number_part: "ஒன்பது எட்டு ஏழு ஆறு ஐந்து நான்கு மூன்று இரண்டு ஒன்று பூஜ்யம்" }
