...
from nemo_text_processing.text_normalization.bn.taggers.cardinal import CardinalFst
from nemo_text_processing.text_normalization.bn.taggers.date import DateFst
from nemo_text_processing.text_normalization.bn.taggers.decimal import DecimalFst
from nemo_text_processing.text_normalization.bn.taggers.fraction import FractionFst
from nemo_text_processing.text_normalization.bn.taggers.money import MoneyFst
from nemo_text_processing.text_normalization.bn.taggers.ordinal import OrdinalFst
from nemo_text_processing.text_normalization.bn.taggers.punctuation import PunctuationFst
from nemo_text_processing.text_normalization.bn.taggers.telephone import TelephoneFst
from nemo_text_processing.text_normalization.bn.taggers.time import TimeFst
from nemo_text_processing.text_normalization.bn.taggers.whitelist import WhiteListFst
from nemo_text_processing.text_normalization.bn.taggers.word import WordFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            from nemo_text_processing.text_normalization.bn.taggers.math import MathFst
