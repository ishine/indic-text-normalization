...
# Chhattisgarhi digits: ०-९ (0-9) - Devanagari script
NEMO_CG_DIGIT = pynini.union("०", "१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_CG_NON_ZERO = pynini.union("१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_CG_ZERO = "०"
...
CG_DEDH = "डेढ़"  # 1.5
CG_DHAI = "ढाई"  # 2.5
CG_SAVVA = "सवा"  # quarter more (1.25)
CG_SADHE = "साढ़े"  # half more (X.5)
CG_PAUNE = "पौने"  # quarter less (0.75)
