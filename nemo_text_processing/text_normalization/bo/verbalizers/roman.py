...
from nemo_text_processing.text_normalization.bo.graph_utils import NEMO_NOT_QUOTE, GraphFst
...
class RomanFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        try:
            ...
            from nemo_text_processing.text_normalization.bo.graph_utils import NEMO_SIGMA
