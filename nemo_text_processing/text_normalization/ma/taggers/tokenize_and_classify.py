...
from nemo_text_processing.text_normalization.ma.taggers.abbreviation import AbbreviationFst
from nemo_text_processing.text_normalization.ma.taggers.cardinal import CardinalFst
from nemo_text_processing.text_normalization.ma.taggers.date import DateFst
from nemo_text_processing.text_normalization.ma.taggers.decimal import DecimalFst
from nemo_text_processing.text_normalization.ma.taggers.electronic import ElectronicFst
from nemo_text_processing.text_normalization.ma.taggers.fraction import FractionFst
from nemo_text_processing.text_normalization.ma.taggers.measure import MeasureFst
from nemo_text_processing.text_normalization.ma.taggers.money import MoneyFst
from nemo_text_processing.text_normalization.ma.taggers.ordinal import OrdinalFst
from nemo_text_processing.text_normalization.ma.taggers.punctuation import PunctuationFst
from nemo_text_processing.text_normalization.ma.taggers.range import RangeFst
from nemo_text_processing.text_normalization.ma.taggers.roman import RomanFst
from nemo_text_processing.text_normalization.ma.taggers.serial import SerialFst
from nemo_text_processing.text_normalization.ma.taggers.telephone import TelephoneFst
from nemo_text_processing.text_normalization.ma.taggers.time import TimeFst
from nemo_text_processing.text_normalization.ma.taggers.whitelist import WhiteListFst
from nemo_text_processing.text_normalization.ma.taggers.word import WordFst
from nemo_text_processing.text_normalization.ma.verbalizers.date import DateFst as vDateFst
from nemo_text_processing.text_normalization.ma.verbalizers.ordinal import OrdinalFst as vOrdinalFst
from nemo_text_processing.text_normalization.ma.verbalizers.time import TimeFst as vTimeFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            start_time = time.time()
            from nemo_text_processing.text_normalization.ma.taggers.math import MathFst
