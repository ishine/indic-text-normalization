...
class DateFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        # Malayalam digits for year patterns
        ...
        # Match converted Malayalam year against patterns and compose with cardinal
        ...
        # Combined year graphs (supports both Malayalam and Arabic digits)
        ...
        # Support both Malayalam and Arabic digits for days and months
        # Malayalam digits path: Malayalam digits -> days/months mapping
        ...
        # Arabic digits path: Arabic digits -> convert to Malayalam -> days/months mapping
        ...
        # Combined graphs (supports both Malayalam and Arabic digits)
