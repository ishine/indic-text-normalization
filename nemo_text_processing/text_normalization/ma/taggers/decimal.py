...
class DecimalFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        # Support both Malayalam and Arabic digits for fractional part
        # Malayalam digits path: Malayalam digits -> cardinal digit/zero mapping
        ...
        # Arabic digits path: Arabic digits -> convert to Malayalam -> cardinal digit/zero mapping
        ...
        # Combined fractional digit graph (supports both Malayalam and Arabic digits)
        ...
        # Support both Malayalam and Arabic digits for integer part
        cardinal_graph = cardinal.final_graph
        
        # Malayalam digits input for integer part
        ...
        # Combined integer graph (supports both Malayalam and Arabic digits)
