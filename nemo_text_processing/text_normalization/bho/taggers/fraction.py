...
class FractionFst(GraphFst):
    ...
    Finite state transducer for classifying fractions, e.g.
        २३ ४/६ -> fraction { integer_part: "तेईस" numerator: "चार" denominator: "छह" }
        3/4 -> fraction { numerator: "तीन" denominator: "चार" }
    
    Following Tamil/English fraction tagger pattern.
    """

    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        super().__init__(name="fraction", kind="classify", deterministic=deterministic)

        # Use cardinal.final_graph like Tamil uses
