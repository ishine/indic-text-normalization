...
from nemo_text_processing.text_normalization.ne.utils import get_abs_path, load_labels
...
class SerialFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, ordinal: GraphFst, deterministic: bool = True, lm: bool = False):
        ...
        """
        if deterministic:
            # For Nepali, use final_graph for numbers
        ...
        # Note: In Nepali, ordinals use Nepali digits (०-९) while serials use ASCII digits (0-9)
        ...
        try:
            ...
            # This is acceptable since Nepali ordinals and serials use different digit systems
            pass
