...
from nemo_text_processing.text_normalization.ne.graph_utils import MINUS, NEMO_NOT_QUOTE, GraphFst, insert_space
from nemo_text_processing.text_normalization.ne.taggers.decimal import quantities
...
class DecimalFst(GraphFst):
    ...
    Finite state transducer for classifying decimal, e.g.
        ...
        decimal { integer_part: "बारह" quantity: "billion" } -> बारह अर्ब
