...
class PowerFst(GraphFst):
    ...
    Finite state transducer for verbalizing power, e.g.
        power { base: "ಹತ್ತು" sign: "ಮೈನಸ್" exponent: "ಏಳು" } -> ಹತ್ತು ಘಾತ ಮೈನಸ್ ಏಳು
        power { base: "ಎರಡು" exponent: "ಮೂರು" } -> ಎರಡು ಘಾತ ಮೂರು
    """
    ...
    def __init__(self, deterministic: bool = True):
        ...
        graph = base + pynutil.insert(" ಘಾತ ") + optional_sign + exponent
