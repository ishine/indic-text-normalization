...
"""
Script to generate roman_to_spoken.tsv for Hindi.
This maps Roman numerals to Hindi number words.
"""
...
def num_to_hindi(num):
    """Convert number to Hindi words using data files."""
    if num == 0:
        return "शून्य"
...
def generate_roman_to_spoken_tsv(output_file):
    """Generate roman_to_spoken.tsv file with Roman numeral to Hindi word mappings."""
    generated_mappings = []
