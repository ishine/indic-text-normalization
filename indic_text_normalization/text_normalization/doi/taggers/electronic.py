...
from indic_text_normalization.text_normalization.doi.graph_utils import (  # common string literals
    MIN_NEG_WEIGHT,
    NEMO_ALPHA,
    NEMO_DIGIT,
    NEMO_NOT_SPACE,
...
class ElectronicFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        if deterministic:
            ...
            # For non-deterministic, use cardinal's final graph for numbers
            numbers = pynutil.insert(" ") + cardinal.final_graph + pynutil.insert(" ")
