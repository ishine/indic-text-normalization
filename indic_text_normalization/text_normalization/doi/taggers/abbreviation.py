...
from indic_text_normalization.text_normalization.doi.graph_utils import NEMO_UPPER, GraphFst, insert_space


class AbbreviationFst(GraphFst):
    """
    Finite state transducer for classifying abbreviations
