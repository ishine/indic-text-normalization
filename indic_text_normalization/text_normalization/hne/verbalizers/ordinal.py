...
from indic_text_normalization.text_normalization.hne.graph_utils import NEMO_NOT_QUOTE, GraphFst, delete_space


class OrdinalFst(GraphFst):
    """
    Finite state transducer for verbalizing Chhattisgarhi ordinals, e.g.
