...
class SerialFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, ordinal: GraphFst, deterministic: bool = True, lm: bool = False):
        ...
        # Note: In Malayalam, ordinals use Malayalam digits (൦-൯) while serials use ASCII digits (0-9)
        ...
        try:
            ...
            # This is acceptable since Malayalam ordinals and serials use different digit systems
            pass
