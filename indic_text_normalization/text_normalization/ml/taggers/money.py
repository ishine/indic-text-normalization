...
class MoneyFst(GraphFst):
    ...
    Finite state transducer for classifying money, suppletive aware, e.g.
        ₹൫൦ -> money { money { currency_maj: "രൂപ" integer_part: "അമ്പത്" }
        ₹൫൦.൫൦ -> money { currency_maj: "രൂപ" integer_part: "അമ്പത്" fractional_part: "അമ്പത്" currency_min: "centiles" }
        ₹൦.൫൦ -> money { currency_maj: "രൂപ" integer_part: "പൂജ്യം" fractional_part: "അമ്പത്" currency_min: "centiles" }
