...
from indic_text_normalization.text_normalization.brx.graph_utils import NEMO_ALPHA, NEMO_SIGMA, GraphFst
from indic_text_normalization.text_normalization.brx.utils import get_abs_path, load_labels
...
class RomanFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        for k_word in load_labels(get_abs_path("data/roman/key_word.tsv")):
            ...
            key_words.append([k_word[0][0].upper() + k_word[0][1:] if len(k_word[0]) > 1 else k_word[0].upper()])
